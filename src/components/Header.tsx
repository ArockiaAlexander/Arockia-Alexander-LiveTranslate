...
import { Volume2, VolumeX, Wifi, WifiOff, Sparkles, Sliders, Info, CheckCircle2, AlertCircle, Play, Music } from 'lucide-react';
...
interface HeaderProps {
  ...
  activeView: 'single' | 'dual' | 'dialect' | 'offline';
  onChangeView: (view: 'single' | 'dual' | 'dialect' | 'offline') => void;
}
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex md:hidden py-2 border-t border-slate-100 overflow-x-auto gap-1">
          <button
            onClick={() => onChangeView('single')}
          ...
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 max-h-[88vh] overflow-y-auto">
            ...
            <div className="p-4 bg-gradient-to-br from-amber-50 to-orange-50/50 border border-amber-200/80 rounded-2xl mb-5">
              ...
              <div className="grid grid-cols-2 gap-2 pt-2 border-t border-amber-200/60 text-xs">
                <div>
                  <label className="block text-[11px] font-bold text-amber-950 mb-1">Synthesis Engine</label>
